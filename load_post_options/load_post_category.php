...
$post="";
	...
	$query_load_post=mysqli_query($con,"SELECT * from posts where categories=$category_name order by id DESC");
	...
	if ($num>0) {
		...
		while($row=mysqli_fetch_array($query_load_post)){
			if (strstr($row['repored_by'],$user_name_logged_in_val)==false) {
						...
						if($interval->y >= 1) {
							...
							<div class='post-body'>
								...
								<div class=' post-body-text'>
									...
									if ($row['added_by']==$user_name_logged_in_val) {
