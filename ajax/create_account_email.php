...
//     echo "<script>var email = sessionStorage.getItem('reg_email');
//     alert(email)</script>";
//     ob_enf_fluch();
// }
...
<div class="back_to_create_account_option">
    <img src="images/arrow_left.png" alt="" class="back_to_create_account_option_arrow">
</div>
<script>
    $('.back_to_create_account_option_arrow').click(function () {
        $.ajax({
            url: 'ajax/create_account_options.php',
            type: 'POST',
            data: {
