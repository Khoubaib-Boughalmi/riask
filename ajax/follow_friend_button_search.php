...
if (strstr($user_logged_in_following,$user_clicked_name)==false) {
    ...
    echo "<script>document.querySelector('.follow_friend_button_search_friend_$user_clicked_name').style.cssText ='background-color: rgb(42, 206, 69);border:.2rem solid rgba(42, 206, 69, 0.87);transition: opacity 1.5s;color: #fff;opacity:0;';</script>";
    echo'followed';
}
?>